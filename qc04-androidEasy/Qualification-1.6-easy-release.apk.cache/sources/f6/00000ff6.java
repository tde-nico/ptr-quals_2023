...
public class MainActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(org.esa.ptr23.qualification.easy.R.layout.activity_main);
    ...
    private void installActionBarLogo() {
        ...
        supportActionBar.setTitle(org.esa.ptr23.qualification.easy.R.string.app_title);
        supportActionBar.setDisplayOptions(supportActionBar.getDisplayOptions() | 16);
        ImageView imageView = new ImageView(supportActionBar.getThemedContext());
        imageView.setScaleType(ImageView.ScaleType.FIT_END);
        imageView.setImageResource(org.esa.ptr23.qualification.easy.R.drawable.logo);
    ...
    public void onStart() {
        super.onStart();
        this.txPassword = (EditText) findViewById(org.esa.ptr23.qualification.easy.R.id.txPassword);
    }

    public void verifyPasswordClick(View view) {
        if (!Verifier.verifyPassword(this, this.txPassword.getText().toString())) {
            Toast.makeText(this, (int) org.esa.ptr23.qualification.easy.R.string.dialog_failure, 1).show();
        } else {
            showSuccessDialog();
        }
    }
    ...
    private void showSuccessDialog() {
        ...
        dialog.setTitle(org.esa.ptr23.qualification.easy.R.string.dialog_title);
        dialog.setContentView(org.esa.ptr23.qualification.easy.R.layout.dialog_success);
        dialog.show();
    }
}
...
public final class ViewKt {
    public static /* synthetic */ void $r8$lambda$Y6wGMU_rQCvb5uOg5WbipwD8gCc(Function0 function0) {
        m179postOnAnimationDelayed$lambda1(function0);
    }
    ...
    public static final Runnable postOnAnimationDelayed(View view, long j, final Function0<Unit> action) {
        Intrinsics.checkNotNullParameter(view, "<this>");
        Intrinsics.checkNotNullParameter(action, "action");
        Runnable runnable = new Runnable() { // from class: androidx.core.view.ViewKt$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public static final void m179postOnAnimationDelayed$lambda1(Function0 action) {
        Intrinsics.checkNotNullParameter(action, "$action");
        action.invoke();
    }

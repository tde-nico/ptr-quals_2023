    ...
    public final void run() {
        ...
        try {
            ...
            if (job != null && !job.isActive()) {
                ...
                continuation.resumeWith(Result.m277constructorimpl(successfulResult$kotlinx_coroutines_core));
            }
            ...
            handleFatalException(null, Result.m280exceptionOrNullimpl(m277constructorimpl2));
        } catch (Throwable th2) {
            try {
            ...
            handleFatalException(th2, Result.m280exceptionOrNullimpl(m277constructorimpl));
        }
    }

...
public class ShortcutInfoCompat {
    ...
    static Person[] getPersonsFromExtra(PersistableBundle persistableBundle) {
        ...
        if (persistableBundle != null) {
            containsKey = persistableBundle.containsKey(EXTRA_PERSON_COUNT);
            if (containsKey) {
                i = persistableBundle.getInt(EXTRA_PERSON_COUNT);
    ...
    static boolean getLongLivedFromExtra(PersistableBundle persistableBundle) {
        ...
        boolean z;
        if (persistableBundle != null) {
            containsKey = persistableBundle.containsKey(EXTRA_LONG_LIVED);
            if (containsKey) {
    ...
    public static List<ShortcutInfoCompat> fromShortcuts(Context context, List<ShortcutInfo> list) {
        ...
        for (ShortcutInfo shortcutInfo : list) {
            arrayList.add(new Builder(context, PackageInfoCompat$$ExternalSyntheticApiModelOutline0.m76m((Object) shortcutInfo)).build());
        }
        return arrayList;
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:5:0x0004, code lost:
        r2 = r2.getString(androidx.core.content.pm.ShortcutInfoCompat.EXTRA_LOCUS_ID);
     */
    /*
    ...
    */
    private static androidx.core.content.LocusIdCompat getLocusIdFromExtra(android.os.PersistableBundle r2) {
        ...
        L4:
            ...
            java.lang.String r2 = androidx.core.content.pm.PackageInfoCompat$$ExternalSyntheticApiModelOutline0.m83m(r2, r1)
            if (r2 != 0) goto Ld
            goto L12
        Ld:

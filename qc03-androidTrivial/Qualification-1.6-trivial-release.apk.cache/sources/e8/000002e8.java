...
public final class AppOpsManagerCompat {
    ...
    public static int noteOp(Context context, String str, int i, String str2) {
        if (Build.VERSION.SDK_INT >= 19) {
            return Api19Impl.noteOp(NavUtils$$ExternalSyntheticApiModelOutline0.m8m(context.getSystemService("appops")), str, i, str2);
        }
        return 1;
    }
    ...
    public static int noteOpNoThrow(Context context, String str, int i, String str2) {
        if (Build.VERSION.SDK_INT >= 19) {
            return Api19Impl.noteOpNoThrow(NavUtils$$ExternalSyntheticApiModelOutline0.m8m(context.getSystemService("appops")), str, i, str2);
        }
        return 1;
    }
    ...
    public static int noteProxyOp(Context context, String str, String str2) {
        if (Build.VERSION.SDK_INT >= 23) {
            return Api23Impl.noteProxyOp(NavUtils$$ExternalSyntheticApiModelOutline0.m8m(Api23Impl.getSystemService(context, NavUtils$$ExternalSyntheticApiModelOutline0.m22m())), str, str2);
        }
        return 1;
    }
    ...
    public static int noteProxyOpNoThrow(Context context, String str, String str2) {
        if (Build.VERSION.SDK_INT >= 23) {
            return Api23Impl.noteProxyOpNoThrow(NavUtils$$ExternalSyntheticApiModelOutline0.m8m(Api23Impl.getSystemService(context, NavUtils$$ExternalSyntheticApiModelOutline0.m22m())), str, str2);
        }
        return 1;
    }

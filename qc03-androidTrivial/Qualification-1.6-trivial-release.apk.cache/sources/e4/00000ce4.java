...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo1837scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m1772delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m1773toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m1773toDelayMillisLRDsOJo(long j) {
        if (Duration.m1613compareToLRDsOJo(j, Duration.Companion.m1716getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1632getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
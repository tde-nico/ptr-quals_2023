...
public class NotificationCompat {
    ...
    public static class Builder {
        ...
        public Builder(Context context, Notification notification) {
            ...
            if (actionArr != null) {
                ...
                if (actionArr2.length != 0) {
                    ...
                    for (Notification.Action action : actionArr3) {
            ...
            String[] stringArray = bundle2.getStringArray(NotificationCompat.EXTRA_PEOPLE);
            ...
            if (Build.VERSION.SDK_INT >= 28) {
                ...
                ArrayList parcelableArrayList = bundle3.getParcelableArrayList(NotificationCompat.EXTRA_PEOPLE_LIST);
                if (parcelableArrayList != null && !parcelableArrayList.isEmpty()) {
                    Iterator it = parcelableArrayList.iterator();
                    while (it.hasNext()) {
                        addPerson(Person.fromAndroidPerson(NotificationCompat$$ExternalSyntheticApiModelOutline1.m44m(it.next())));
                    }
                }
            }
        ...
        public RemoteViews createHeadsUpContentView() {
            ...
            if (style == null || (makeHeadsUpContentView = style.makeHeadsUpContentView(notificationCompatBuilder)) == null) {
                ...
                remoteViews = build.headsUpContentView;
                return remoteViews;
            }
    ...
    public static abstract class Style {
        ...
        private static Style constructCompatStyleByPlatformName(String str) {
            if (str != null && Build.VERSION.SDK_INT >= 16) {
                if (str.equals(NotificationCompat$$ExternalSyntheticApiModelOutline1.m().getName())) {
                    return new BigPictureStyle();
                }
                if (str.equals(NotificationCompat$$ExternalSyntheticApiModelOutline1.m$1().getName())) {
                    return new BigTextStyle();
                }
                if (str.equals(NotificationCompat$$ExternalSyntheticApiModelOutline1.m$2().getName())) {
                    return new InboxStyle();
                }
                if (Build.VERSION.SDK_INT >= 24) {
                    if (str.equals(NotificationCompat$$ExternalSyntheticApiModelOutline1.m$3().getName())) {
                        return new MessagingStyle();
                    }
                    if (str.equals(NotificationCompat$$ExternalSyntheticApiModelOutline1.m$4().getName())) {
    ...
    public static class BigPictureStyle extends Style {
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            if (Build.VERSION.SDK_INT >= 16) {
                bigContentTitle = new Notification.BigPictureStyle(notificationBuilderWithBuilderAccessor.getBuilder()).setBigContentTitle(this.mBigContentTitle);
        ...
        private static IconCompat asIconCompat(Parcelable parcelable) {
            if (parcelable != null) {
                if (Build.VERSION.SDK_INT >= 23 && NotificationCompat$$ExternalSyntheticApiModelOutline1.m61m((Object) parcelable)) {
                    return IconCompat.createFromIcon(NotificationCompat$$ExternalSyntheticApiModelOutline1.m49m((Object) parcelable));
                }
    ...
    public static class BigTextStyle extends Style {
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            if (Build.VERSION.SDK_INT >= 16) {
                bigContentTitle = new Notification.BigTextStyle(notificationBuilderWithBuilderAccessor.getBuilder()).setBigContentTitle(this.mBigContentTitle);
                bigText = bigContentTitle.bigText(this.mBigText);
                if (this.mSummaryTextSet) {
    ...
    public static class MessagingStyle extends Style {
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            if (Build.VERSION.SDK_INT >= 16) {
                ...
                bigContentTitle = new Notification.BigTextStyle(notificationBuilderWithBuilderAccessor.getBuilder()).setBigContentTitle(null);
                bigContentTitle.bigText(spannableStringBuilder);
            }
        }
                ...
                try {
                    if (bundle.containsKey(KEY_TEXT) && bundle.containsKey(KEY_TIMESTAMP)) {
                        if (bundle.containsKey(KEY_PERSON)) {
                            ...
                            build = Person.fromAndroidPerson(NotificationCompat$$ExternalSyntheticApiModelOutline1.m44m((Object) bundle.getParcelable(KEY_NOTIFICATION_PERSON)));
                        } else {
    ...
    public static class InboxStyle extends Style {
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            if (Build.VERSION.SDK_INT >= 16) {
                bigContentTitle = new Notification.InboxStyle(notificationBuilderWithBuilderAccessor.getBuilder()).setBigContentTitle(this.mBigContentTitle);
                if (this.mSummaryTextSet) {
    ...
    public static class Action {
        ...
        public static final class Builder {
            ...
            /* JADX WARN: Removed duplicated region for block: B:16:0x0046 A[LOOP:0: B:15:0x0044->B:16:0x0046, LOOP_END] */
            ...
            */
            public static androidx.core.app.NotificationCompat.Action.Builder fromAndroidAction(android.app.Notification.Action r5) {
                /*
                    ...
                    r1 = 23
                    if (r0 < r1) goto L22
                    android.graphics.drawable.Icon r0 = androidx.core.app.NotificationCompat$$ExternalSyntheticApiModelOutline1.m47m(r5)
                    if (r0 == 0) goto L22
                    android.graphics.drawable.Icon r0 = androidx.core.app.NotificationCompat$$ExternalSyntheticApiModelOutline1.m47m(r5)
                    ...
                    java.lang.CharSequence r2 = androidx.core.app.NotificationCompat$$ExternalSyntheticApiModelOutline1.m54m(r5)
                    android.app.PendingIntent r3 = androidx.core.app.NotificationCompat$$ExternalSyntheticApiModelOutline1.m43m(r5)
                    r1.<init>(r0, r2, r3)
                    goto L33
                L22:
                    androidx.core.app.NotificationCompat$Action$Builder r1 = new androidx.core.app.NotificationCompat$Action$Builder
                    int r0 = androidx.core.app.NotificationCompat$$ExternalSyntheticApiModelOutline1.m(r5)
                    java.lang.CharSequence r2 = androidx.core.app.NotificationCompat$$ExternalSyntheticApiModelOutline1.m54m(r5)
                    android.app.PendingIntent r3 = androidx.core.app.NotificationCompat$$ExternalSyntheticApiModelOutline1.m43m(r5)
                    r1.<init>(r0, r2, r3)
                L33:
                    ...
                    r2 = 20
                    if (r0 < r2) goto L52
                    android.app.RemoteInput[] r0 = androidx.core.app.NotificationCompat$$ExternalSyntheticApiModelOutline1.m63m(r5)
                    if (r0 == 0) goto L52
                    int r2 = r0.length
                    if (r2 == 0) goto L52
                    int r2 = r0.length
                ...
                L52:
                    ...
                    r2 = 24
                    if (r0 < r2) goto L5e
                    boolean r0 = androidx.core.app.NotificationCompat$$ExternalSyntheticApiModelOutline1.m$2(r5)
                    r1.mAllowGeneratedReplies = r0
                L5e:
                    int r0 = android.os.Build.VERSION.SDK_INT
                    r2 = 28
                    if (r0 < r2) goto L6b
                    int r0 = androidx.core.app.NavUtils$$ExternalSyntheticApiModelOutline0.m(r5)
                    r1.setSemanticAction(r0)
                L6b:
                    int r0 = android.os.Build.VERSION.SDK_INT
                    r2 = 29
                    if (r0 < r2) goto L78
                    boolean r0 = androidx.core.app.NotificationCompat$$ExternalSyntheticApiModelOutline1.m59m(r5)
                    r1.setContextual(r0)
                L78:
                    int r0 = android.os.Build.VERSION.SDK_INT
                    r2 = 31
                    if (r0 < r2) goto L85
                    boolean r5 = androidx.core.app.NotificationCompat$$ExternalSyntheticApiModelOutline1.m$1(r5)
        ...
        public static final class WearableExtender implements Extender {
            ...
            /* renamed from: clone */
            public WearableExtender m70clone() {
    ...
    public static final class WearableExtender implements Extender {
                ...
                if (Build.VERSION.SDK_INT >= 16 && parcelableArrayList != null) {
                    ...
                    for (int i = 0; i < size; i++) {
                        if (Build.VERSION.SDK_INT >= 20) {
                            actionArr[i] = NotificationCompat.getActionCompatFromAction(NotificationCompat$$ExternalSyntheticApiModelOutline1.m(parcelableArrayList.get(i)));
        ...
        /* renamed from: clone */
        public WearableExtender m71clone() {
            WearableExtender wearableExtender = new WearableExtender();
    ...
    public static final class CarExtender implements Extender {
        ...
        private static UnreadConversation getUnreadConversationFromBundle(Bundle bundle) {
            ...
            android.app.RemoteInput m45m = NotificationCompat$$ExternalSyntheticApiModelOutline1.m45m((Object) bundle.getParcelable(KEY_REMOTE_INPUT));
            String[] stringArray = bundle.getStringArray(KEY_PARTICIPANTS);
            if (stringArray == null || stringArray.length != 1) {
                return null;
            }
            if (m45m != null) {
                resultKey = m45m.getResultKey();
                label = m45m.getLabel();
                choices = m45m.getChoices();
                allowFreeFormInput = m45m.getAllowFreeFormInput();
                if (Build.VERSION.SDK_INT >= 29) {
                    editChoicesBeforeSending = m45m.getEditChoicesBeforeSending();
                    i = editChoicesBeforeSending;
                } else {
                    i = 0;
                }
                extras = m45m.getExtras();
                remoteInput = new RemoteInput(resultKey, label, choices, allowFreeFormInput, i, extras, null);
            }
    ...
    public static Action getAction(Notification notification, int i) {
        ...
        if (Build.VERSION.SDK_INT >= 19) {
            ...
            bundle = notification.extras;
            SparseArray sparseParcelableArray = bundle.getSparseParcelableArray(NotificationCompatExtras.EXTRA_ACTION_EXTRAS);
            Bundle bundle2 = sparseParcelableArray != null ? (Bundle) sparseParcelableArray.get(i) : null;
            i2 = action.icon;
            charSequence = action.title;
            pendingIntent = action.actionIntent;
            return NotificationCompatJellybean.readAction(i2, charSequence, pendingIntent, bundle2);
        } else if (Build.VERSION.SDK_INT >= 16) {
    ...
    static Action getActionCompatFromAction(Notification.Action action) {
        ...
        if (remoteInputs == null) {
            ...
            for (int i6 = 0; i6 < remoteInputs.length; i6++) {
                ...
                remoteInputArr2[i6] = new RemoteInput(resultKey, label, choices, allowFreeFormInput, i, extras, null);
            }
        ...
        boolean z5 = extras3.getBoolean("android.support.action.showsUserInterface", true);
        if (Build.VERSION.SDK_INT >= 28) {
        ...
        if (Build.VERSION.SDK_INT >= 23) {
            ...
            if (icon == null) {
                ...
                if (i4 != 0) {
                    ...
                    return new Action(i5, charSequence3, pendingIntent3, extras7, remoteInputArr, (RemoteInput[]) null, z4, i7, z5, z2, z3);
                }
            }
            ...
            return new Action(iconCompat, charSequence2, pendingIntent2, extras6, remoteInputArr, (RemoteInput[]) null, z4, i7, z5, z2, z3);
        }
        i3 = action.icon;
        charSequence = action.title;
        pendingIntent = action.actionIntent;
        extras5 = action.getExtras();
        return new Action(i3, charSequence, pendingIntent, extras5, remoteInputArr, (RemoteInput[]) null, z4, i7, z5, z2, z3);
    }
    ...
    public static List<Person> getPeople(Notification notification) {
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            if (parcelableArrayList != null && !parcelableArrayList.isEmpty()) {
                Iterator it = parcelableArrayList.iterator();
                while (it.hasNext()) {
                    arrayList.add(Person.fromAndroidPerson(NotificationCompat$$ExternalSyntheticApiModelOutline1.m44m(it.next())));
                }
            }
    ...
    public static boolean getLocalOnly(Notification notification) {
        ...
        if (Build.VERSION.SDK_INT >= 20) {
            ...
            bundle = notification.extras;
            return bundle.getBoolean(NotificationCompatExtras.EXTRA_LOCAL_ONLY);
        } else if (Build.VERSION.SDK_INT >= 16) {
    ...
    public static String getGroup(Notification notification) {
        ...
        if (Build.VERSION.SDK_INT >= 20) {
            ...
            bundle = notification.extras;
            return bundle.getString(NotificationCompatExtras.EXTRA_GROUP_KEY);
        } else if (Build.VERSION.SDK_INT >= 16) {
    ...
    public static boolean isGroupSummary(Notification notification) {
        ...
        if (Build.VERSION.SDK_INT >= 20) {
            ...
            bundle = notification.extras;
            return bundle.getBoolean(NotificationCompatExtras.EXTRA_GROUP_SUMMARY);
        } else if (Build.VERSION.SDK_INT >= 16) {
    ...
    public static String getSortKey(Notification notification) {
        ...
        if (Build.VERSION.SDK_INT >= 20) {
            ...
            bundle = notification.extras;
            return bundle.getString(NotificationCompatExtras.EXTRA_SORT_KEY);
        } else if (Build.VERSION.SDK_INT >= 16) {
    ...
    */
    public static androidx.core.content.LocusIdCompat getLocusId(android.app.Notification r3) {
        /*
            ...
            r2 = 0
            if (r0 < r1) goto L12
            android.content.LocusId r3 = androidx.core.app.NotificationCompat$$ExternalSyntheticApiModelOutline1.m46m(r3)
            if (r3 != 0) goto Le
            goto L12
        Le:

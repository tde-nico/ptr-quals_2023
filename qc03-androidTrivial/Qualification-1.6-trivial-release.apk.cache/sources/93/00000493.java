...
public final class BundleKt {
    public static final Bundle bundleOf(Pair<String, ? extends Object>... pairs) {
        ...
        for (Pair<String, ? extends Object> pair : pairs) {
            ...
            } else if (Build.VERSION.SDK_INT >= 21 && BundleKt$$ExternalSyntheticApiModelOutline0.m138m(component2)) {
                BundleApi21ImplKt.putSize(bundle, component1, BundleKt$$ExternalSyntheticApiModelOutline0.m125m(component2));
            } else if (Build.VERSION.SDK_INT >= 21 && BundleKt$$ExternalSyntheticApiModelOutline0.m$1(component2)) {
                BundleApi21ImplKt.putSizeF(bundle, component1, BundleKt$$ExternalSyntheticApiModelOutline0.m126m(component2));
            } else {

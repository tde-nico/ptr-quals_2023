...
public class WindowInsetsCompat {
    ...
    public static class Impl20 extends Impl {
        ...
        private Insets getVisibleInsets(View view) {
            ...
            if (method != null && sAttachInfoClass != null && sVisibleInsetsField != null) {
                try {
                    ...
                    sb.append(message);
                    Log.e(WindowInsetsCompat.TAG, sb.toString(), e);
                }
            }
            return null;
        }
        ...
        public boolean equals(Object obj) {
            if (super.equals(obj)) {
                return Predicate$$ExternalSyntheticBackport0.m(this.mRootViewVisibleInsets, ((Impl20) obj).mRootViewVisibleInsets);
            }
            return false;
        }
    }
    ...
    private static class Impl28 extends Impl21 {
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof Impl28) {
                ...
                return Predicate$$ExternalSyntheticBackport0.m(this.mPlatformInsets, impl28.mPlatformInsets) && Predicate$$ExternalSyntheticBackport0.m(this.mRootViewVisibleInsets, impl28.mRootViewVisibleInsets);
            }
            return false;
        }
    ...
    private static class BuilderImpl20 extends BuilderImpl {
        ...
        private static WindowInsets createWindowInsetsInstance() {
            if (!sConsumedFieldFetched) {
                try {
                    sConsumedField = WindowInsetsCompat$$ExternalSyntheticApiModelOutline0.m194m().getDeclaredField("CONSUMED");
                } catch (ReflectiveOperationException e) {
            ...
            if (!sConstructorFetched) {
                try {
                    sConstructor = WindowInsetsCompat$$ExternalSyntheticApiModelOutline0.m194m().getConstructor(Rect.class);
    ...
    public static class Api21ReflectionHolder {
        ...
        static {
            ...
            try {
                ...
                message = e.getMessage();
                sb.append(message);
                Log.w(WindowInsetsCompat.TAG, sb.toString(), e);
            }
        }

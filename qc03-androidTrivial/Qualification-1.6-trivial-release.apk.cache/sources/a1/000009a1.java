        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t != t2) {
                ...
                if ((t instanceof Object[]) && (t2 instanceof Object[])) {
                    ...
                    if (!UArraysKt.m843contentEqualskV0jMPg(((UByteArray) t).m361unboximpl(), ((UByteArray) t2).m361unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UShortArray) && (t2 instanceof UShortArray)) {
                    if (!UArraysKt.m840contentEqualsFGO6Aew(((UShortArray) t).m621unboximpl(), ((UShortArray) t2).m621unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UIntArray) && (t2 instanceof UIntArray)) {
                    if (!UArraysKt.m841contentEqualsKJPZfPQ(((UIntArray) t).m439unboximpl(), ((UIntArray) t2).m439unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof ULongArray) && (t2 instanceof ULongArray)) {
                    if (!UArraysKt.m845contentEqualslec5QzE(((ULongArray) t).m517unboximpl(), ((ULongArray) t2).m517unboximpl())) {
                        return false;
                    }
    ...
    private static final <T> void contentDeepToStringInternal$ArraysKt__ArraysKt(T[] tArr, StringBuilder sb, List<Object[]> list) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t == null) {
                ...
                sb.append(UArraysKt.m857contentToString2csIQuQ(uByteArray != null ? uByteArray.m361unboximpl() : null));
            } else if (t instanceof UShortArray) {
                UShortArray uShortArray = (UShortArray) t;
                sb.append(UArraysKt.m861contentToStringd6D3K8(uShortArray != null ? uShortArray.m621unboximpl() : null));
            } else if (t instanceof UIntArray) {
                UIntArray uIntArray = (UIntArray) t;
                sb.append(UArraysKt.m860contentToStringXUkPCBk(uIntArray != null ? uIntArray.m439unboximpl() : null));
            } else if (t instanceof ULongArray) {
                ULongArray uLongArray = (ULongArray) t;
                sb.append(UArraysKt.m863contentToStringuLth9ew(uLongArray != null ? uLongArray.m517unboximpl() : null));
            } else {

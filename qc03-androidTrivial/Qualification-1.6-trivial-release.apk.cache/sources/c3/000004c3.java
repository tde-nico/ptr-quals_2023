...
public class UserHandleCompat {
    ...
    public static UserHandle getUserHandleForUid(int i) {
        ...
        try {
            return HalfKt$$ExternalSyntheticApiModelOutline0.m((Object) getUserHandleConstructor().newInstance((Integer) getGetUserIdMethod().invoke(null, Integer.valueOf(i))));
    ...
    private static Method getGetUserIdMethod() throws NoSuchMethodException {
        if (sGetUserIdMethod == null) {
            Method declaredMethod = HalfKt$$ExternalSyntheticApiModelOutline0.m$1().getDeclaredMethod("getUserId", Integer.TYPE);
    ...
    private static Constructor<UserHandle> getUserHandleConstructor() throws NoSuchMethodException {
        if (sUserHandleConstructor == null) {
            Constructor<UserHandle> declaredConstructor = HalfKt$$ExternalSyntheticApiModelOutline0.m$1().getDeclaredConstructor(Integer.TYPE);

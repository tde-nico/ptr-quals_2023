...
final class ReceiveChannel$onReceiveOrNull$1$registerSelectClause1$1<E, R> extends SuspendLambda implements Function2<ChannelResult<? extends E>, Continuation<? super R>, Object> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2) {
        return m1811invokeWpGqRn0(((ChannelResult) obj).m1807unboximpl(), (Continuation) obj2);
    }

    /* renamed from: invoke-WpGqRn0  reason: not valid java name */
    public final Object m1811invokeWpGqRn0(Object obj, Continuation<? super R> continuation) {
        return ((ReceiveChannel$onReceiveOrNull$1$registerSelectClause1$1) create(ChannelResult.m1795boximpl(obj), continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            Object m1807unboximpl = ((ChannelResult) this.L$0).m1807unboximpl();
            Throwable m1799exceptionOrNullimpl = ChannelResult.m1799exceptionOrNullimpl(m1807unboximpl);
            if (m1799exceptionOrNullimpl != null) {
                throw m1799exceptionOrNullimpl;
            }
            Object m1800getOrNullimpl = ChannelResult.m1800getOrNullimpl(m1807unboximpl);
            this.label = 1;
            obj = this.$block.invoke(m1800getOrNullimpl, this);

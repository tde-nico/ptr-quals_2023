...
final class AdjustedTimeMark implements TimeMark {
    ...
    public final long m1609getAdjustmentUwyO8pc() {
    ...
    public long mo1606elapsedNowUwyO8pc() {
        return Duration.m1649minusLRDsOJo(this.mark.mo1606elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo1608plusLRDsOJo(long j) {
        return new AdjustedTimeMark(this.mark, Duration.m1650plusLRDsOJo(this.adjustment, j), null);
    }
}
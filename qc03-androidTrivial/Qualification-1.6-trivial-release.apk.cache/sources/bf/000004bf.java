...
public final class TraceCompat {
    ...
    static {
        ...
        try {
            sTraceTagApp = HalfKt$$ExternalSyntheticApiModelOutline0.m().getField("TRACE_TAG_APP").getLong(null);
            sIsTagEnabledMethod = HalfKt$$ExternalSyntheticApiModelOutline0.m().getMethod("isTagEnabled", Long.TYPE);
            sAsyncTraceBeginMethod = HalfKt$$ExternalSyntheticApiModelOutline0.m().getMethod("asyncTraceBegin", Long.TYPE, String.class, Integer.TYPE);
            sAsyncTraceEndMethod = HalfKt$$ExternalSyntheticApiModelOutline0.m().getMethod("asyncTraceEnd", Long.TYPE, String.class, Integer.TYPE);
            sTraceCounterMethod = HalfKt$$ExternalSyntheticApiModelOutline0.m().getMethod("traceCounter", Long.TYPE, String.class, Integer.TYPE);
        } catch (Exception e) {

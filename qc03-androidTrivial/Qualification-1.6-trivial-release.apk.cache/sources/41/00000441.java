...
public class FingerprintManagerCompat {
    ...
    public void authenticate(CryptoObject cryptoObject, int i, CancellationSignal cancellationSignal, AuthenticationCallback authenticationCallback, Handler handler) {
        ...
        Api23Impl.authenticate(fingerprintManagerOrNull, wrapCryptoObject(cryptoObject), cancellationSignal != null ? PackageInfoCompat$$ExternalSyntheticApiModelOutline0.m77m(cancellationSignal.getCancellationSignalObject()) : null, i, wrapCallback(authenticationCallback), handler);
    }
